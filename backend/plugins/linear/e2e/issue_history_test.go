...
func TestLinearIssueHistoryDataFlow(t *testing.T) {
	...
	dataflowTester.ImportCsvIntoRawTable("./raw_tables/_raw_linear_issue_history.csv", "_raw_linear_issue_history")
	dataflowTester.FlushTabler(&models.LinearIssueHistory{})
	dataflowTester.Subtask(tasks.ExtractIssueHistoryMeta, taskData)
	dataflowTester.VerifyTableWithOptions(models.LinearIssueHistory{}, e2ehelper.TableOptions{
		CSVRelPath:  "./snapshot_tables/_tool_linear_issue_history.csv",
		IgnoreTypes: []interface{}{common.NoPKModel{}},
	})

	// verify conversion: tool layer -> domain layer
	dataflowTester.FlushTabler(&ticket.IssueChangelogs{})
	dataflowTester.Subtask(tasks.ConvertIssueHistoryMeta, taskData)
