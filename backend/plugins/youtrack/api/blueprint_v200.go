...
func makePipelinePlanV200(
	subtaskMetas []plugin.SubTaskMeta,
	scopeDetails []*srvhelper.ScopeDetail[models.YoutrackProject, models.YoutrackScopeConfig],
...
// makeScopesV200 maps each attached project to its domain scope: a
// ticket.Board. The board id is generated from the internal project id only,
// so it stays stable when the project's shortName is renamed upstream.
func makeScopesV200(
	scopeDetails []*srvhelper.ScopeDetail[models.YoutrackProject, models.YoutrackScopeConfig],
	connection *models.YoutrackConnection,
) ([]plugin.Scope, errors.Error) {
	scopes := make([]plugin.Scope, 0, len(scopeDetails))
	idgen := didgen.NewDomainIdGenerator(&models.YoutrackProject{})
